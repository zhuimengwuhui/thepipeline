...
def make_pipeline(state):
    ...
    (pipeline.transform(
        ...
        filter=formatter(
            '.+/(?P<sample>[a-zA-Z0-9-]+)_(?P<readid>[a-zA-Z0-9-:]+)_(?P<lib>[a-zA-Z0-9]+)_(?P<lane>[a-zA-Z0-9-]+).intervals'),
    ...
    (pipeline.transform(
        ...
        filter=formatter(
            ...
            '.+/(?P<sample>[a-zA-Z0-9-]+)_(?P<readid>[a-zA-Z0-9-:]+)_(?P<lib>[a-zA-Z0-9]+)_(?P<lane>[a-zA-Z0-9-]+).recal_data.csv'),
            # '.+/(?P<readid>[a-zA-Z0-9-]+)_(?P<lib>[a-zA-Z0-9-:]+)_(?P<lane>[a-zA-Z0-9]+)_(?P<sample>[a-zA-Z0-9-]+).recal_data.csv'),
    ...
    pipeline.collate(
        ...
        filter=formatter(
            ...
            '.+/(?P<sample>[a-zA-Z0-9-]+)_(?P<readid>[a-zA-Z0-9-:]+)_(?P<lib>[a-zA-Z0-9]+)_(?P<lane>[a-zA-Z0-9-]+).sort.dedup.realn.recal.bam'),
